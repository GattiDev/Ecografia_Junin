...
<div id="box">
    <div class="planillaMedica">
        ...
        <form id="frmPlanillaMedica" action="controllers/update_PlanillaMedica.php" method="post" enctype="multipart/form-data">
            ...
            <input class="btn_sub submit" type="submit" name="submit" value="Aceptar">

...
<?php 
    ...
    include ('../../setting/conexionPDF.php');
    ...
    if(isset($_POST['submit'])){ 
        ...
        $Put_studies = $Put_Model->Put_studies($paciente_file, $fecha, $destino_file);
        ...
        $carpeta_destino = 'Files Patient/' . $dni_patient . '~' . $name_patient . '/'. $name_destiny . '/' . $fecha . '/'; 

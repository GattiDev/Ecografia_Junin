<?PHP 
    ...
    $get_studie = $Get_Model->Get_IdStudies($id_paciente);
?>
				...
				<?php 
					...
					while($paciente = mysqli_fetch_assoc($get_paciente)){ 
						...
						<nav  aria-label="breadcrumb" >
							<ol class="breadcrumb" >
								<li class="breadcrumb-item active nav-dataAct" aria-current="page"><?php echo $name;?></li>
							</ol>
						</nav>
						...
						<?php
               			...
               			while($studie = mysqli_fetch_assoc($get_studie)){  
							...
							$id_destiny = $studie['id_destiny'];
								...
								$Get_Model = new Get_Model();
								$get_destiny = $Get_Model->Get_destiny($id_destiny);
								...
								while($destiny = mysqli_fetch_assoc($get_destiny)){ 
									...
									<div class="menu">
										...
										<p></p>
										<a href="fecha-planilla.php?p=<?php echo $id_paciente;?>&d=<?php echo $id_destiny;?>">Ver</a>
									</div>

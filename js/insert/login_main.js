...
function login(){
    ...
    document.getElementById("boxInputName").style.marginLeft = "180px"; /*315px*/
    document.getElementById("boxInputName").style.marginTop = "35px"; /*35px*/
    ...
    document.getElementById("boxInputPass").style.marginLeft = "180px"; /*315px*/
    document.getElementById("boxInputPass").style.marginTop = "35px"; /*35px*/
